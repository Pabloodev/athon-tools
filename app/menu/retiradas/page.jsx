...
import { runWithdrawal } from "@/app/lib/actions/actions";
import { previewCard } from "@/app/data/previewCard";

export default async function Page() {
    return (
        <div className="flex flex-col min-h-screen items-center justify-center relative gap-20">

            <Link href={"/home"} className="flex items-center hover:text-gray-400 transition duration-500 absolute top-6 left-5">
                <ChevronLeft />
                <span>Menu</span>
            </Link>
            ...
            <div className="flex flex-col gap-4 items-center text-lg">
                ...
                <button onClick={runWithdrawal} className="hover:bg-blue-950">Ativar Robo</button>
            </div>
